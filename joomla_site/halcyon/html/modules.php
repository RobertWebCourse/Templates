...
<?php function modChrome_descHead($module, $params, $attribs) { ?>
	<div class="h-theme-block">
		<?php if ($module->showtitle) : ?>
			<?php echo '<' ?><?php echo $params->get('header_tag').' class="'. $params->get('header_class') .'">' . $module->title . '</' . $params->get('header_tag')?><?php echo '>' ?>
			<span></span>
		<?php endif; ?>
	</div>
...
<?php function modChrome_descNews($module, $params, $attribs) { ?>
	<?php if ($module->showtitle) : ?>
		<div class="h-theme-block">
			<?php echo '<' ?><?php echo $params->get('header_tag').' class="'. $params->get('header_class') .'">' . $module->title . '</' . $params->get('header_tag')?><?php echo '>' ?>
			<span></span>
...
<?php function modChrome_firstSlide($module, $params, $attribs) { ?>
	<?php if ($module->showtitle) : ?>
		<div class="h-theme-block">
			<?php echo '<' ?><?php echo $params->get('header_tag').' class="'. $params->get('header_class') .'">' . $module->title . '</' . $params->get('header_tag')?><?php echo '>' ?>
			<span></span>
...
<?php function modChrome_secondSlide($module, $params, $attribs) { ?>
	<?php echo $module->content ?>
<?php } ?>

<?php function modChrome_3thslide($module, $params, $attribs) { ?>
	<?php if ($module->showtitle) : ?>
		<div class="h-theme-block">
			<?php echo '<' ?><?php echo $params->get('header_tag').' class="'. $params->get('header_class') .'">' . $module->title . '</' . $params->get('header_tag')?><?php echo '>' ?>
			<span></span>
...
<?php function modChrome_contacts($module, $params, $attribs) { ?>
	<?php if ($module->showtitle) : ?>
		<div class="h-theme-block">
			<?php echo '<' ?><?php echo $params->get('header_tag').' class="'. $params->get('header_class') .'">' . $module->title . '</' . $params->get('header_tag')?><?php echo '>' ?>
			<span></span>
